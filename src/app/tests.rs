...
fn settings_focus_order_matches_gui_ids_and_is_distinct() {
    ...
    assert_eq!(order[14], gui::id("settings/cursor_style"));
    assert_eq!(order[15], gui::id("settings/cursor_blink"));
    assert_eq!(order[16], gui::id("settings/config"));
    assert_eq!(order[17], gui::id("settings/save"));
